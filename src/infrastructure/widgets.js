...
class LoginPopupSelf extends Component {
    ...
    perm_alert() {
        alert('因为这个其实是用 Pku helper 的源码魔改的，为避免麻烦拒绝弄登录功能，只是借用官方的 token 和 api。token 仅存储于本地并不会上传，事实上要不是懒得改其他代码我都不想储存 token。');
    }
        ...
        return ReactDOM.createPortal(
            <div>
                ...
                <div className="pkuhelper-login-popup">
                    <p>
                        <b>输入token以授权</b><a onClick={this.perm_alert.bind(this)}>(?)</a>
                    </p>
                    <p>
